...
export const quotes: Array<IQuote> = [
  ...
  },
  {
    index: 55,
    message:
      '조직을 만들어야 할 가장 좋은 이유는 의미를 만들기 위해서이다. 세상을 더 좋은 곳으로 만드는 제품이나 서비스를 만들기 위해서이다.',
    author: '가이 카와사키',
  },
  {
    index: 56,
  ...
  },
  {
    index: 65,
    message:
      '내가 강해질 용기를 낼 때, 내 힘을 내 비전을 위해 사용할 때 내가 두려워하는지 여부는점점덜 중요해진다.',
    author: '오드리 로드',
  },
  {
    index: 66,
  ...
  },
  {
    index: 73,
    message:
      '앞을 보며 점과 점을 연결할 수는 없다. 뒤돌아볼 때만 가능하다. 그러니 당신은 미래에 언젠가 점들이 연결될 거라고 믿어야 한다. 무언가를 믿어야 한다. 당신의 직감, 운명, 삶, 카르마, 뭐든지. 이 접근법은 한 번도 나를 실망시킨 적이 없고, 내 삶의 모든 것을 이뤄내게 해주었다.',
    author: '스티브 잡스',
  },
  {
    index: 74,
    message:
      '성공한 사람들은 성공하지 않은 사람들이 하지 않으려는 것을 한다. 더 쉬웠으면 하고 바라지말고 내가 더 나았으면 하고 바라라.',
    author: '짐 론',
  },
  {
    index: 75,
  ...
  },
  {
    index: 76,
    message:
      '대부분의 사람들이 결코 목표를 이루지 못하는 이유는 그들은 목표를 정의하지 않거나, 단 한번도 진지하게 그 목표가 믿을 수 있는 것, 이룰 수 있는 것이라고 생각해보지 않기 때문이다. 승리하는 사람들은 자신이 어디로 가고 있는지, 그 과정에서 어떤 일을 할 계획인지, 그 모험을 누구와 함께 할 것인지 알고 있다.',
    author: '데니스 웨이틀리',
  },
  {
    index: 77,
  ...
  },
  {
    index: 79,
    message:
      '내 삶이 끝날 때 내가 내 삶의 길이만큼만 살았다는 걸 깨닫고 싶지 않다. 내 삶의 폭도 살고싶다.',
    author: '다이앤 애커먼',
  },
  {
    index: 80,
  ...
  },
  {
    index: 84,
    message:
      '우리의 가장 큰 공포는 실패에 대한 공포가 아니라 인생에서 진정 중요하지 않은 일들에 성공하는 것에 대한 두려움이어야 한다.',
    author: '프랜시스 찬',
  },
  {
    index: 85,
  ...
  },
  {
    index: 87,
    message:
      '성공이란 당신 삶의 목적을 깨닫고, 당신의 잠재력을 전부 발휘하고, 남들에게 도움이 되는 씨를 뿌리는 것이다.',
    author: '존 C. 맥스웰',
  },
  {
    index: 89,
    message:
      '위대한 것을 이루려면 우리는 행동할 뿐 아니라 꿈도 꾸어야 하고, 계획할 뿐 아니라 믿기도해야 한다.',
    author: '아나톨 프랑스',
  },
  {
    index: 90,
  ...
  },
  {
    index: 137,
    message:
      '어릴 적 나에겐 정말 많은 꿈이 있었고, 그 꿈의 대부분은 많은 책을 읽을 기회가 많았기 가능했다고 생각한다.',
    author: '빌 게이츠',
  },
  {
    index: 138,
  ...
  },
  {
    index: 148,
    message:
      '연금술사는 이렇게 말했다. ‘배움에는 행동을 통해 배우는 단 한가지 방법이 있을 뿐이라네’',
    author: '파울로 코엘류',
  },
  {
    index: 151,
  ...
  },
  {
    index: 161,
    message:
      '행복의 문이 하나 닫히면 다른 문이 열린다. 그러나 종종 우리는 닫힌 문을 멍하니 바라보다가 우리로 향해 열린 문을 보지 못하게 된다.',
    author: '헬렌 켈러',
  },
  {
    index: 162,
